...
def gettone():
    global nome, squadriglia, specialita, primo, secondo, terzo, tappa, carattere, salute, aiuto, nulla
    nulla = " "
...
ro.title("IMPEGNI SCOUT")
a = Label(ro, text="IMPEGNI SCOUT")
a.pack()
